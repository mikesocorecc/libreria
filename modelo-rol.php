...
if($_POST['registro'] == 'nuevo'){   
    try {
        if(!empty($nombre) && !empty($descripcion) ){
            ...
            $stmt = $conn->prepare("INSERT INTO  rol (nombrerol, descripcion, editado) VALUES (?, ?, NOW() ) ");
...
if($_POST['registro'] == 'actualizar') {
    ...
    try {
        ...
        $stmt = $conn->prepare(" UPDATE rol SET nombrerol = ?, descripcion = ?, editado = NOW() WHERE idrol = ? ");
